    ...
    */
    ...
    while (money > 0) {
        ...
        if (money >= totalPrice) {
            ...
            document.getElementById("receipt").innerHTML += "<p>On Day " + day + ", sandwiches are: $"
                + priceToday + ". You have $" + money.toFixed(2) + " left.</p>";
        }
        else {
...
function getSandwichPrice() {
    var randomSandwichPrice = (Math.random() * (5 - 1) + 1).toFixed(2);
    return randomSandwichPrice;
}
