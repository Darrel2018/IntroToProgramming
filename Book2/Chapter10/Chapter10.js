...
// add replace button listener.
var replaceButton = document.getElementById("replaceButton");
replaceButton.addEventListener("click", replaceIt);

// This function will create the story and display it on the webpage
function replaceIt() {
    ...
    theStory += "as he " + pastVerb2;
    theStory += " down the stairs to join the " + adjDance + " party.<br><br>";
    theStory += "Douglas danced the " + animal;
    theStory += " Dance, the " + city;
    theStory += " Shake, and took the prize for dancing the best Electric " + verb + ".<br><br>";
